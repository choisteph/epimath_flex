...
load('Workspace2020-03-24-1585097457.Rdata') # (I know, it's really dumb to do this with a workspace, will update later... - M)
...
- The current median across all model simulations for Michigan gives a forecast of almost 2400 cumulative laboratory-confirmed cases by March 31, 2020 (1 week), and roughly 9600 cumulative laboratory-confirmed cases by April 14, 2020 (3 weeks).
- The current median across model simulations projects:
    - March 31, 2020 (1 week): roughly 245 hospitalized patients (beds needed) with almost 50 in ICU 
    - April 14, 2020 (3 weeks): roughly 900 hospitalized patients (beds needed) with roughly 180 in ICU 
