...
load('Workspace2020-03-29-1585535811.RData')
...
### **1-week** forecast of **cumulative COVID-19 deaths** in Michigan {data-height=275}

```{r deathplot1wk, echo=FALSE,message=FALSE,warning=FALSE,error=FALSE, fig.height=3}
...
### **1-week** forecast of COVID-19 **hospitalized patients** (i.e. beds needed) {data-height=275}

```{r hospplot1wk, echo=FALSE,message=FALSE,warning=FALSE,error=FALSE, fig.height=3}
...
### **1-week** forecast of COVID-19 **ICU occupancy** (i.e. beds needed) {data-height=275}

```{r ICUplot1wk, echo=FALSE,message=FALSE,warning=FALSE,error=FALSE, fig.height=3}
...
### **1-week** forecast of current COVID-19 **patients needing O$_2$ support** {data-height=275}

```{r O2plot1wk, echo=FALSE,message=FALSE,warning=FALSE,error=FALSE,fig.height=3}
...
### **1-week** forecast of current COVID-19 **patients needing ventilators** {data-height=275}

```{r ventplot1wk, echo=FALSE,message=FALSE,warning=FALSE,error=FALSE, fig.height=3}
