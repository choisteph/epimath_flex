...
load('Workspace2020-03-25-1585110153.Rdata') # (I know, it's really dumb to do this with a workspace, will update later... - M)
...
### Updated March 25, 2020 <!--`r format(Sys.Date(), "%B %e, %Y")`-->
...
- The current median across all model simulations for Michigan gives a forecast of roughly 3100 cumulative laboratory-confirmed cases by April 1, 2020 (1 week), and roughly 12400 cumulative laboratory-confirmed cases by April 15, 2020 (3 weeks).
- The current median across model simulations projects:
    - April 1, 2020 (1 week): roughly 320 hospitalized patients (beds needed) with roughly 60 in ICU 
    - April 15, 2020 (3 weeks): almost 1200 hospitalized patients (beds needed) with roughly 230 in ICU 
...
### **Broad rules of thumb to explore**
...
```{r table}
paramtable = P[c(1,4:25),c(1:4,6,7)]
