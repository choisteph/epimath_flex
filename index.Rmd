...
### One Week Forecast of COVID-19 Cases in Michigan {data-width300}

<!-- i added an iframe element here just in case i can get this graphic on shiny instead -->
<!-- <iframe></iframe> -->
```{r forecastplot1wk, echo=FALSE,message=FALSE,warning=FALSE,error=FALSE,fig.width=4}
...
ggplotly(forecastplot, width=300, height=245,
         tooltip = c("text")) %>%
...
### Three Week Forecast of COVID-19 Cases in Michigan {data-height=275}
...
ggplotly(deathplot, width=300, height=245, tooltip = c("text")) %>%
  layout(legend = list(x = 0.05, y = 0.9,
      orientation = "h"),
      xaxis = list(
        type = 'date',
