...
//This code is the JQuery that adds quality-of-life-improvement navigation links (click the title or logo to be redirected to the homepage) to the nav bar. The original elements that RMarkdown creates are basic <span> elements and they don't process hrefs (links) as well as <a> (anchor) elements do.
  ...
  $(document).ready( function(){
    //When the document is ready (aka it has finished loading), do the following:
      ...
      $(".navbar-brand").replaceWith("<a class='navbar-brand' href= './'>Michigan COVID-19 Mapping</a>")
      ...
      $(".navbar-logo").replaceWith("<div class='navbar-logo pull-left' ><a href='./'><img class='navbrand-img' src='logo.png'></a></div>")
...
oneweekcumcase <-  ggplotly(forecastplot, tooltip = c("text")) %>%
    layout(
      legend = list(
        x = 0.05,
        y = 0.9,
...
threeweekcumcase <-  ggplotly(forecast2plot, tooltip = c("text")) %>%
    layout(
      legend = list(
        x = 0.05,
        y = 0.9,
  ...
  allplots <- subplot(oneweekcumcase, threeweekcumcase, nrows=2, margin = 0.05)
...
renderPlotly({
  ...
  threeweekdeath <- ggplotly(deathplot, tooltip = c("text")) %>%
    layout(
      legend = list(
        x = 0.05,
        y = 0.9,
...
renderPlotly({
  ...
  threeweekhosp <- ggplotly(hospburden, tooltip = c("text")) %>%
    layout(
      legend = list(
        x = 0.05,
        y = 0.9,
...
renderPlotly({
  ...
  threeweekicu <- ggplotly(ICUburden, tooltip = c("text")) %>%
    layout(
      legend = list(
        x = 0.05,
        y = 0.9,
...
renderPlotly({
  ...
  threeweeko2 <- ggplotly(O2burden, tooltip = c("text")) %>%
    layout(
      legend = list(
        x = 0.05,
        y = 0.9,
