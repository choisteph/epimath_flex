...
<!-- <iframe></iframe> -->
```{r forecastplot1wk, echo=FALSE,message=FALSE,warning=FALSE,error=TRUE}
...
<!-- <iframe></iframe> -->
```{r forecastplot3wk, echo=FALSE,message=FALSE,warning=FALSE,error=TRUE}
