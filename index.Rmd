...
<!-- <iframe></iframe> -->
```{r forecastplot1wk, fig.width = 4, fig.height = 3}
...
ggplotly(forecastplot, width = 800,height = 600,
         tooltip = c("text")) %>%
...
<!-- <iframe></iframe> -->
```{r forecastplot3wk, fig.width = 4, fig.height = 3}
  ybestfit = yobscumcarefun(xestlh,paramestslh)
...
ggplotly(forecast2plot, width = 800, height = 600, tooltip = c("text")) %>%
  layout(legend = list(x = 0.05, y = 0.9,
      orientation = "h"),
      xaxis = list(
        type = 'date',
