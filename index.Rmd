...
output: 
  flexdashboard::flex_dashboard:
    ...
    theme: yeti
    navbar:
      - {title: explorables1, align: right}
      - {title: explorables2, align: right}
...
### One Week Forecast of COVID-19 Cases in Michigan {data-height=275}
...
ggplotly(forecastplot, width=150, height=100, tooltip = c("text")) %>%
...
Social Distancing Scenarios {data-navmenu= "explorables2}
===================================== 
