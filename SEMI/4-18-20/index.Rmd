...
load('Workspace2020-04-18-1587219759.RData') # (I know, it's really dumb to do this with a workspace, will update later... - M)
...
deathdata = read_csv("~/Box Sync/COVID Response Modeling/Data - Web/MIcumdeath_by_hand_jp.csv")
deathtimes = as.Date(deathdata$Date,format = "%m/%d/%y")
